...
const acertou = [
  ...
  (acertou4 = document.createElement("p")),
  (acertou5 = document.createElement("a")),
];
acertou[0].innerText = "Você acertou!";
acertou[1].innerText = "A capital de";
acertou[2].innerText = "é";
acertou[3].innerText = paisSorteado.capital;
acertou[4].innerText = "Jogar Novamente?";
...
function ganhou() {
  ...
  h1Header.classList.add("acertou");
  acertou[4].setAttribute("href", link);
  acertou.forEach((item) => {
    document.querySelector("section").appendChild(item);
  });
  document.querySelector("section").insertBefore(paisSorteadoH1, acertou[2]);
  document.querySelector("section").classList.add("inlineblock");
}
//
